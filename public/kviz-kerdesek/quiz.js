...
function showQuestion(question) {
    questionNumberElement.innerText =
        currentQuestionIndex + 1 + "/" + allQuestions;
...
function selectAnswer(e) {
    ...
    if (selectButton.dataset.description) {
        ...
        if (selectedType == 1) {
            descriptionContents[e.target.answerNum].classList.remove("hide");
        } else {
...
const questionsOne = [
    ...
    {
        question:
            "Hol található Magyarország legnagyobb, modern hulladéklerakója?",
        answers: [
            {
                text: "Bátaapáti",
                correct: false,
    ...
    {
        question:
            "Hozzávetőlegesen hány ember él vízhiányos régiókban a Földön?",
        answers: [
            {
                text: "1 milliárd",
                correct: false,
...
const questionsTrueOrFalse = [
    ...
    {
        question:
            "Igaz vagy hamis? Magyarország vízben gazdag országnak számít?",
        answers: [
            {
                text: "Igaz",
                correct: false,
...
const questionsFromEightToTen = [
    ...
    {
        question:
            "Melyik közlekedési eszköz szennyezi legkevésbé a környezetet?",
        answers: [
    ...
    {
        question:
            "Melyik közlekedési eszköz szennyezi leginkább a környezetet?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            {
                text: "helyi zöldségek, gyümölcsök",
                correct: true,
                description: "",
            },
    ...
    },
    {
        ...
        answers: [
            { text: "felaprítani", correct: true, description: "" },
            { text: "elmosni", correct: false, description: "" },
            { text: "szétválogatni", correct: false, description: "" },
        ],
    },
    {
        question:
