    ...
    <div class="container w-full mx-auto">
        <div class="flex flex-wrap">
            ...
            <div class="pr-0 xl:pr-10">
                <div class="grid grid-cols-2 gap-4 bg-black text-white mt-10 rounded-bl-own">
                    ...
                    <div>
                        <img
                        src="{{asset('images/prevention/image11-51.jpeg')}}"
                        alt="logo"
                        />
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-4 mt-12 mb-12">
                    ...
                    <div class="w-full mx-16">
                        <p>
                            A tiszta környezet az emberek számára egy alapvető igény és kötelesség. A szomszédságok és közösségek egy nyugodtabb, tisztább, egészségesebb és élhetőbb életteret tudnak teremteni maguknak a szennyezés megelőzésével. A hulladék nem megfelelő kezelése (amelyet gyakran a mennyisége idéz elő) a hulladéklerakókban talaj és vízkészletek szennyezéséhez, tüzeléssel légszennyezéshez és egyéb környezeti károkozásokhoz vezethet.
                        </p>
                    </div>
                    ...
                    <div class="w-full px-4 mt-5">
                     ...
                     <div class="w-full mx-16">
                         <p>
                            Gyakori tévhit, hogy a környezettudatos életmód egy drága életmód. A felesleges termékek megvásárlásának elkerülése, a régi árucikkek újrahasználata vagy újrahasznosítása jelentős megtakarításokat eredményezhet. Fontos megjegyezni, a túlfogyasztásból származó termékekért kétszer is fizetünk: a megvásárlásakor és az ártalmatlanításkor.<br/>
                            Az anyagi haszon mellett, a korábban közösségi érdekként említett, biztonságos, tisztább és élhetőbb környezet szintén kihatással van egészségünkre és közérzetünkre.
                         </p>
                     </div>
                     ...
                     <div class="w-full mx-16">
                         <p>
                            A legfontosabb, hogy a hulladék megelőzését és kezelését a napi rutin részeként kell kezelni. Az újragondolás elsődleges célja ennek a rutintevékenységnek a megtervezése.
                         </p>
                         <ul class="list-decimal ml-5 mt-5 mb-2">
                            <li>
                                Gyűjtsük össze milyen hulladékfajtákat és mennyit dobunk ki, illetve ezek keletkezésének okát.
                            </li>
                            <li>
                                Határozzunk meg lehetséges megoldásokat a mennyiség csökkentésére.
                            </li>
                            <li>
                                Tűzzünk ki magunk elé reális célokat. Próbáljunk kezdetben a könnyen megvalósítható, gazdaságos és számunkra leghasznosabb megelőzési módokat alkalmazni. A kisebb célok (kevesebb papír vagy műanyag használata) elérése is képes sikerélményt okozni.
                            </li>
                            <li>
                     ...
                     <div class="w-full mx-16">
                         <p>
                            „A boltokban termékeit már legyártották, ha nem veszem meg akkor a bolt dobja ki helyettem”. Bár az állítás a jelenlegi helyzetben igaz, azonban a vásárlók alacsonyabb fogyasztásához idővel igazodni fognak az üzletek, amely a túltermelést is visszaszorítja.
                         </p>
                     </div>
                     ...
                     <div class="w-full mx-16">
                         <p>
                            A kezdeti állapot felmérésének itt van igazán nagy szerepe. Követhetjük mennyivel csökken a heti vagy havi hulladéktermelésünk és kiadásaink. Nem szabad azonban elfelejtkeznünk a közvetett hatásokról sem (sikerélmény, környezetvédelem, tanulási lehetőség), amelyek javíthatják közérzetünket és önértékelésünket.
                         </p>
                     </div>
                 </div>
            </div>
        ...
        <div class="pr-0 xl:pr-10">
            <div class="grid grid-cols-2 gap-4 bg-black text-white mt-10 mb-5  rounded-bl-own">
                ...
                <div>
                    <img
                    src="{{asset('images/prevention/image15-55.jpeg')}}"
                    alt="logo"
                    />
                </div>
            </div>
                ...
                <div class="w-full px-4 mt-1">
                 ...
                 <div class="w-full px-4 mt-1">
                    <div class="mb-2 flex group">
                     ...
                     <div class="w-full items-center justify-center">
                          <p class="text-base leading-relaxed items-center justify-center">
                            Tartós termékek vásárlása (újratölthető elemek, bevásárlószatyrok, zsebkendők, törlőruhák) az egyszerhasználatos termékek helyett. 
                          </p>
                       </div>
                    </div>
                 </div>
        ...
        <div class="pr-0 xl:pr-10 mt-20">
            <div class="grid grid-cols-2 gap-4 bg-black text-white mt-10 mb-5  rounded-bl-own">
                ...
                <div>
                    <img
                    src="{{asset('images/prevention/image16-57.jpeg')}}"
                    alt="logo"
                    />
                </div>
            </div>
                ...
                <div class="w-full px-4 mt-1">
                 ...
                 <div class="w-full px-4 mt-1">
                    <div class="mb-2 flex group">
                     ...
                     <div class="w-full items-center justify-center">
                          <p class="text-base leading-relaxed items-center justify-center">
                            ruhák, bútorok és elektronikai eszközök felajánlása jótékony célra (Ökumenikus Segélyszervezet)
                          </p>
                       </div>
                    </div>
                 </div>
