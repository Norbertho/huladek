<footer class="bg-darkblue pt-20 lg:pt-[120px] relative overflow-hidden z-10">
    <div class="container">
          ...
          <div class="w-full sm:w-2/3 lg:w-4/12 xl:w-3/12 px-4">
             <div class="w-full mb-10">
                <a
                   ...
                   >
                <img
                   src="{{asset('images/SZECHENYI.png')}}"
                   alt="logo"
                   class="max-w-full"
                   />
                </a>
          ...
          <div class="w-full md:w-1/2 lg:w-4/12 xl:w-3/12 px-4">
             <div class="w-full mb-10">
                ...
                <a
                   ...
                   >
                   <div class="w-full max-w-[70px] rounded mr-5 overflow-hidden">
                      <img
                         src="https://cdn.tailgrids.com/1.0/assets/images/footers/footer-04/blog-01.jpg"
                         alt="image"
                         class="w-full"
                         />
                   </div>
                ...
                <a
                   ...
                   <div class="w-full max-w-[70px] rounded mr-5 overflow-hidden">
                      <img
                         src="https://cdn.tailgrids.com/1.0/assets/images/footers/footer-04/blog-02.jpg"
                         alt="image"
                         class="w-full"
                         />
                   </div>
          ...
          <svg
             ...
             <defs>
                <linearGradient
                   ...
                   >
                   <stop stop-color="#00a252" stop-opacity="0.4" />
          ...
          <svg
             ...
             <defs>
                <linearGradient
                   ...
                   gradientUnits="userSpaceOnUse"
                   >
                   <stop stop-color="#00a252" stop-opacity="0.32" />
                   <stop offset="1" stop-opacity="0" />
                </linearGradient>
             </defs>
          </svg>
