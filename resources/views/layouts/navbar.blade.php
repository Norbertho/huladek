      ...
      <div class="container">
                ...
                >
                  ...
                  <li class="relative hover:text-darkblue group">
                    ...
                    type="button"
                      ...
                      href="javascript:void(0)"
                      class=" text-base font-bold uppercase text-dark 2xl:text-white hover:text-darkblue py-2 2xl:inline-flex flex 2xl:ml-8">
                      <div class="flex hover:text-darkblue"> <span>Lakossági hulladékkezelés</span>              <svg class="text-white group-hover:text-darkblue ml-1 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        ...
        >
            <div class="bg-basegreen block">
                <a href="hulladekrol-altalanossagban" class="block w-full px-4 py-2 text-left text-sm font-bold uppercase text-dark 2xl:text-white hover:text-darkblue" >
