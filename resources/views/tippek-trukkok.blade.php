...
<div class="bg-basegreen pt-16">
    <div class="bg-basegreen pt-16 pb-10 head">
        <div class="container mx-auto head-img">
            ...
            <h1 class="font-bold text-3xl sm:text-4xl md:text-[40px] text-white mt-6 mb-12 ml-6 title">
                Tippek, <br /><span class="ml-8">trükkök</span>
            </h1>
        </div>
    </div>
</div>
    ...
    <div class="container mx-auto mt-24">
        <div class="flex flex-wrap">
            <div class="w-full">
                <div class="pr-0 xl:pr-10">
                    <h2 class="text-2xl font-semibold text-darkblue mt-12 mb-2">
                        Többszörhasználatos termékek, amelyekkel kevesebb hulladékot termelünk:
                    </h2>
            ...
            <div class="w-full">
                <div class="pr-0 xl:pr-10">
                    <h2 class="text-2xl font-semibold text-darkblue mt-12 mb-2">
                        Fürdőszobai tippek és termékek:
                    </h2>
            ...
            <div class="w-full">
                <div class="pr-0 xl:pr-10">
                    <h2 class="text-2xl font-semibold text-darkblue mt-12 mb-2">
                        Ruházati tippek az alacsonyabb hulladéktermelésért:
                    </h2>
                    ...
                    <div
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base leading-8">
                                ...
                                táptalajt termel
                                kertünk számára. A komposzt kitűnő talajjavító, ezért a nagymértékben hozzájárul a
                                növények és
                                kertünk egészséges fejlődéséhez. Komposztálással továbbá időt és pénzt takaríthatunk
                                meg, hiszen nem
                                kell a zöldhulladék elszállíttatásával vagy műtrágyavásárlással foglalkoznunk.
                            </p>
                        </div>
                    </div>
                </div>
